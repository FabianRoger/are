...
__this script does:__
  ...
  + sensitivity analysis of diveristy metrics to rarefaction
...
In an attempt to reduce a possible sampling bias but without unessecarily discarding data, we choose the following approach:
...
export table with diveristy metrics
...
To get a clearer picture of the differences between the lakes, we look at the average abundace of each OTU, over teh three sampling dates
