...
For each diversity metric, we have three measurements, taken at three time points. Our measure of ecosystem functioning however result in a single value per dilution level and Lake, as they integrate the whole course of the experiment. 

Therefore we have to take the average diversity as predictor variable. In the graph below we show the value of each divert metric plot together for the three sampling dates (colored dots) and the average diversity (black dots)
...
```{r, echo = F}
divPairs3 <- ggpairs(avDIV,
        columns = 4:6, 
        colour = 'Lake', 
        columnLabels = c("effective number\nof species", "phylogenetic\ndiversity", "functional\ndiversity"),
        lower = list(continuous = "smooth"), 
        title = "correlation between the average diveristy metrics by Lake")+
...
To see the correlations between the three metrics of EF and the three divert metrics, we correlate them 
...
It is visible from the scatter-plots that there doesn't seem to be a strong correlation between either of the diversity metrics and either of the metrics of ecosystem functioning. 
